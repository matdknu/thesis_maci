...
if (file.exists(file.path(base_out, "coefplot_ols_polarizacion.png"))) {
  cat('![Coeficientes OLS para polarización.](fig_thesis/coefplot_ols_polarizacion.png){#fig-anexo-coefplot-ols fig-align="center" width="82%"}\n')
}
```
...
if (file.exists(file.path(base_out, "distribucion_estrategias_candidato.png"))) {
  cat('![Estrategias discursivas por candidato objetivo.](fig_thesis/distribucion_estrategias_candidato.png){#fig-anexo-estrategias-candidato fig-align="center" width="82%"}\n')
}
```
